...
Rails.application.routes.draw do
  ...
  get '/settings/delete_tote_set' => 'settings#delete_tote_set'
  get '/settings/create_tote_set' => 'settings#create_tote_set'
  get '/settings/reset_totes' => 'settings#reset_totes'
