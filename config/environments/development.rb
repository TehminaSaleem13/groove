...
Rails.application.configure do
  ...
  redis_options = { host: ENV['REDIS_HOST'], port: ENV['REDIS_PORT'].to_i, password: ENV['REDIS_PASSWORD'] }
  ...
  # Whitelist localpackerapi.com Subdomains
  config.hosts << /.*\.localpackerapi\.com/
end
