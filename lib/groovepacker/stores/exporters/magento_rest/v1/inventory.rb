          ...
          class Inventory < Groovepacker::Stores::Importers::Importer
            ...
            def push_inventories
              ...
              products.each do |product|
                ...
                mg_rest_product_id = (begin
                                        @sync_optn.mg_rest_product_id
                                      rescue StandardError
                                        nil
                                      end) || product.store_product_id
            ...
            def update_mg_rest_product_inv_for_sync_option(_product, mg_rest_product_id, inv_wh)
              if mg_rest_product_id
                availabel_inv = begin
                                   inv_wh.available_inv
                                rescue StandardError
                                  0
                                 end
