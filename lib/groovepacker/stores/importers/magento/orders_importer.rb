    ...
    module Importers
      module Magento
        class OrdersImporter < Groovepacker::Stores::Importers::Importer
            ...
            begin
              ...
              if response.success?
                unless response.body[:sales_order_list_response][:result][:item].blank?
                  ...
                  import_item.save
                  if response.body[:sales_order_list_response][:result][:item].class.to_s.include?("Hash")
                    item = response.body[:sales_order_list_response][:result][:item]
          ...
          def import_single_order(item, import_item, client, response, credential, session, result)
