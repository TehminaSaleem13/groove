    ...
    class Client < Base
      ...
      def orders
        ...
        while page_index
          ...
          filters = { 'page' => page_index.to_s, 'limit' => '10', 'order' => 'created_at', 'dir' => 'dsc' }
      ...
      def products(filters = {})
        ...
        while page_index
          ...
          filters = {
            ...
            'page' => page_index.to_s, 'limit' => '100', 'order' => 'entity_id', 'dir' => 'dsc'
          }
      ...
      def filter_resp_orders_for_last_imported_at(response, last_import, _credential)
        orders_to_return = {}
