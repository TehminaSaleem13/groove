  ...
  module Tenants
    class TenantInitialization
      ...
      def plan_hash(plan)
        ...
        #   'groove-quartet-120' => {'shipments' =>6700, 'users' => 4, 'stores' => 4},
        #   'groove-quintet-150' => {'shipments' =>9000, 'users' => 5, 'stores' => 5},
        ...
        #   'an-groove-quartet' => {'shipments' => 6700, 'users' => 4, 'stores' => 4},
        #   'an-groove-quintet' => {'shipments' => 9000, 'users' => 5, 'stores' => 5},
