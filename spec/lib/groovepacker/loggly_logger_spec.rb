...
RSpec.describe Groovepacker::LogglyLogger do
  describe '.log' do
    ...
    it 'sends the log payload to loggly_logger' do
      ...
      Groovepacker::LogglyLogger.log(request, request_body, log_type, tenant)
    end
    ...
    it 'rescues and logs any errors that occur' do
      ...
      expect { Groovepacker::LogglyLogger.log(request, request_body, log_type, tenant) }.not_to raise_error
    end
  end
end