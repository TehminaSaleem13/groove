...
RSpec.describe ExportSetting, type: :model do
  it 'sets start and end time' do
    export_setting = described_class.new
  ...
  it 'runs scheduled_export callback' do
  ...
  it 'exports data when include partially scanned orders switch is on' do
    export_setting = described_class.first_or_create
  ...
  it 'exports data when include partially scanned orders switch is off' do
    export_setting = described_class.first_or_create
