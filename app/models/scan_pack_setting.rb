class ScanPackSetting < ActiveRecord::Base
  attr_accessible :ask_tracking_number, :enable_click_sku,
                  ...
                  :second_escape_string_enabled, :second_escape_string, :order_verification, :scan_by_hex_number, :return_to_orders, :scanning_sequence, :click_scan, :click_scan_barcode, :scanned, :scanned_barcode, :post_scanning_option_second, :require_serial_lot, :valid_prefixes
