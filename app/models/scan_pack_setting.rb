class ScanPackSetting < ActiveRecord::Base
  attr_accessible :ask_tracking_number, :enable_click_sku,
                  ...
                  :single_item_order_complete_msg, :single_item_order_complete_msg_time, :multi_item_order_complete_msg, :multi_item_order_complete_msg_time, :tote_identifier, :show_expanded_shipments
