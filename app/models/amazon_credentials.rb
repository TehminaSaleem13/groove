class AmazonCredentials < ActiveRecord::Base
  ...
  attr_accessible :marketplace_id, :merchant_id, :import_products, :import_images, :show_product_weight, :show_shipping_weight, :mws_auth_token, :show_shipping_weight_only, :shipped_status, :unshipped_status
