...
function($stateProvider, $urlRouterProvider,hotkeysProvider,cfpLoadingBarProvider,$translateProvider,$urlMatcherFactoryProvider, ngClipProvider) {
    ...
    $stateProvider
        ...
        .state('settings.tools',{url:'/tools', template:'<div ui-view></div>',abstract:true})
        .state('settings.tools.admin_tools',{url:'/tools/admin_tools',templateUrl:'/assets/views/settings/tools/admin_tools.html', controller:'adminToolsCtrl'});
