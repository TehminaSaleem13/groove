  ...
  def permit_scan_pack_setting_params
    ...
    params.as_json(
      only: [
        ...
        :second_escape_string, :order_verification, :scan_by_hex_number, :return_to_orders, :scanning_sequence, :click_scan, :click_scan_barcode  
      ]
    )
  end
  ...
  def permit_general_setting_params
    params.as_json(
      only: [
        ...
        :custom_user_field_one, :custom_user_field_two, :display_kit_parts, :remove_order_items
      ]
    )
  end
