  ...
  def permit_general_setting_params
    params.as_json(
      only: %i[
        ...
        email_address_for_report_out_of_stock
        ...
        custom_user_field_one custom_user_field_two display_kit_parts remove_order_items  delete_import_summary create_barcode_at_import
        print_post_scanning_barcodes print_packing_slips is_haptics_option print_ss_shipping_labels per_box_shipping_label_creation
        barcode_length starting_value show_sku_in_barcodeslip print_product_barcode_labels print_product_receiving_labels new_time_zone truncate_order_number_in_packing_slip
      ]
    )
  end
