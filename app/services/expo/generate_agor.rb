module Expo
  class GenerateAgor
    ...
    def filter_order_data
      @order.slice("id", "increment_id", "order_placed_time", "created_at", "updated_at", "notes_internal", "notes_toPacker", "notes_fromPacker", "status", "tracking_num", "packing_user_id", "notes_from_buyer", "note_confirmation", "custom_field_one", "custom_field_two", :unscanned_items, :scanned_items, :multi_shipments, :activities, :count, :remaining_items_count)
    end
      ...
      @scanned_items.each do |item|
        ...
        unless item["child_items"].nil?
          item["child_items"].each do |child_item|
            scanned_child_items << child_item.slice("name", "instruction", "confirmation", "order_item_id", "images", "sku", "barcodes", "product_id", "location", "location2", "location3", "skippable", "record_serial", "second_record_serial", "click_scan_enabled", "type_scan_enabled", "order_item_id", "custom_product_1", "custom_product_2", "custom_product_3", "custom_product_display_1", "custom_product_display_2", "custom_product_display_3", "partially_scanned", "updated_at", "product_type", "qty_remaining", "total_qty", "scanned_qty")
    ...
    def filter_unscanned_items
      ...
      @unscanned_items.each do |item|
        unscanned_items << item.slice("name", "instruction", "order_item_id", "confirmation", "images", "sku","packing_placement", "barcodes", "product_id", "location", "location2", "location3", "skippable", "record_serial", "second_record_serial", "click_scan_enabled", "type_scan_enabled", "order_item_id", "custom_product_1", "custom_product_2", "custom_product_3", "custom_product_display_1", "custom_product_display_2", "custom_product_display_3", "partially_scanned", "updated_at", "product_type", "qty_remaining", "total_qty", "scanned_qty", "child_items") 
        ...
        unless item["child_items"].nil?
          item["child_items"].each do |child_item|
            unscanned_child_items << child_item.slice("name", "instruction", "confirmation", "order_item_id", "images", "sku", "barcodes", "product_id", "location", "location2", "location3", "skippable", "record_serial", "second_record_serial", "click_scan_enabled", "type_scan_enabled", "order_item_id", "custom_product_1", "custom_product_2", "custom_product_3", "custom_product_display_1", "custom_product_display_2", "custom_product_display_3", "partially_scanned", "updated_at", "product_type", "qty_remaining", "total_qty", "scanned_qty")
