module ScanPack
  class OrderScanService < ScanPack::Base
    ...
    def order_scan
      ...
      do_if_single_order_still_nil and return if @single_order.nil?
      do_if_single_order_still_present
    end
    ...
    def do_if_single_order_still_nil
    ...
    def do_if_single_order_still_present
