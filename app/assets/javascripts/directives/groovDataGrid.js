        ...
        link: function(scope,el,attrs) {
            ...
            myscope._checkSwapNodes = function() {
               ...
               scope.can_render = false;
                ...
                $timeout(myscope._showHideField,100);
            }
            ...
            myscope._init = function() {
                ...
                scope.$on("groov-data-grid-trigger",function() {
                    if(scope.can_render) {
                        ...
                        scope.do_render = true;
                    }
                });
                scope.$watch('can_render',function() {
                    if(scope.can_render && scope.do_render) {
                        $timeout(myscope._checkSwapNodes,10);
                        scope.do_render = false;
                    }
                })
