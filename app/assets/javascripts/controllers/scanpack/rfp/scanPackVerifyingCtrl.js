groovepacks_controllers.
    controller('scanPackVerifyingCtrl', [ '$scope', '$http', '$timeout', '$stateParams', '$location', '$state', '$cookies','orders','scanPack',
        function( $scope, $http, $timeout, $stateParams, $location, $state, $cookies, orders, scanPack) {
            var myscope = {};
            myscope.init = function() {
                $scope.rfpinit().then(function(){
                    $scope.set('title',"Scan Shipping Label for Order "+ $stateParams.order_num+"");
