groovepacks_controllers.controller('aliasModal',['$scope','type','exceptions','id','$timeout','$modalInstance','notification','products',
 function(scope,type,exceptions,id,$timeout,$modalInstance,notification, products) {
