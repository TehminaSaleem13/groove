groovepacks_services.factory('settings',['$http','notification',function($http, notification) {


    var save_column_preference = function(identifier,theads) {
        return $http.post('/settings/save_columns_state.json',{identifier:identifier,theads:theads}).success(function(data) {
            if(data.status) {
