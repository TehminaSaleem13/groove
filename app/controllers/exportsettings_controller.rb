  ...
  def update_export_settings
    ...
    if @export_setting
      if current_user.can? 'edit_general_prefs'
        ...
        @export_seting.stat_export_email = params[:stat_export_email] unless params[:stat_export_email].nil?,
        ...
        @export_sertting.daily_packed_email_on_sat = params[:daily_packed_email_on_sat] unless params[:daily_packed_email_on_sat].nil?,
        @export_setting.daily_packed_email_on_sun = params[:daily_packed_email_on_sun] unless params[:daily_packed_email_on_sun].nil?,
        @export_setting.daily_packed_email = params[:daily_packed_email].nil?
