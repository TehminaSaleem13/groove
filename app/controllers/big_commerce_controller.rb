class BigCommerceController < ApplicationController
  ...
  private
    ...
    def generate_access_token
      ...
      body_attrs = { client_id: ENV['BC_CLIENT_ID'], client_secret: ENV['BC_CLIENT_SECRET'], code: params[:code], scope: params[:scope], grant_type: :authorization_code, redirect_uri: "https://#{ENV['BC_CALLBACK_URL']}/bigcommerce/callback", context: params[:context] }
       begin
