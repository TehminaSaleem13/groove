 ...
 def check_store_type
  ...
  def product_kit_csv_map(csv_map, csv_directory, current_tenant, default_csv_map)
    if ['both', 'product'].include?(params[:type])
      ...
      @result['product']['map_options'] = [ {value: 'product_name', name: 'Product Name'}, {value: 'sku', name: 'SKU'}, {value: 'inv_wh1', name: 'QTY On Hand'}, {value: 'location_primary', name: 'Bin Location'}, {value: 'product_images', name: 'Image Absolute URL'}, {value: 'product_weight', name: 'Weight Oz'}, {value: 'category_name', name: 'Category'}, {value: 'product_instructions', name: 'Packing Instructions'}, {value: 'receiving_instructions', name: 'Receiving Instructions'}, {value: 'secondary_sku', name: 'SKU 2'}, {value: 'tertiary_sku', name: 'SKU 3'}, {value: 'quaternary_sku', name: 'SKU 4'},  {value: 'quinary_sku', name: 'SKU 5'},  {value: 'senary_sku', name: 'SKU 6'}, {value: 'barcode', name: 'Barcode'}, {value: 'barcode_qty', name: 'Barcode 1 qty'}, {value: 'secondary_barcode', name: 'Barcode 2'}, {value: 'secondary_barcode_qty', name: 'Barcode 2 qty'}, {value: 'tertiary_barcode', name: 'Barcode 3'}, {value: 'tertiary_barcode_qty', name: 'Barcode 3 qty'}, {value: 'quaternary_barcode', name: 'Barcode 4'}, {value: 'quaternary_barcode_qty', name: 'Barcode 4 qty'}, {value: 'quinary_barcode', name: 'Barcode 5'}, {value: 'quinary_barcode_qty', name: 'Barcode 5 qty'}, {value: 'senary_barcode', name: 'Barcode 6'}, {value: 'senary_barcode_qty', name: 'Barcode 6 qty'}, {value: 'location_secondary', name: 'Bin Location 2'}, {value: 'location_tertiary', name: 'Bin Location 3'}, {value: 'product_record_serial',name: 'REC SERIAL 1'}, {value: 'product_second_record_serial',name: 'REC SERIAL 2'}, {value: 'is_intangible', name: 'Intangible'}, {value: 'click_scan_enabled', name: 'Click Scan'}, {value: 'is_skippable', name: 'Is Skippable'}, {value: 'add_to_any_order', name: 'Add to any order'}, {value: 'type_scan_enabled', name: 'Type In Count'}, { value: 'custom_product_1', name: 'Custom Product 1'}, { value: 'custom_product_2', name: 'Custom Product 2'}, { value: 'custom_product_3', name: 'Custom Product 3'}, { value: 'custom_product_display_1', name: 'Custom Product Visible 1'}, { value: 'custom_product_display_2', name: 'Custom Product Visible 2'}, { value: 'custom_product_display_3', name: 'Custom Product Visible 3'}, { value: 'packing_placement', name: 'Packing Placement'}, { value: 'packing_instructions_conf', name: 'Packing Instructions Confirmation'}, { value: 'remove_sku', name: 'Remove This SKU'}]
